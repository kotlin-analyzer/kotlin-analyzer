...
fn nested_multi_str_test() {
    ...
    lexer_matches!(&source, [
        ...
        DOT => 65..66, // ".",
        IDENTIFIER_TOKEN => 66..76, // "trimIndent",
        L_PAREN => 76..77, // "(",
        R_PAREN => 77..78, // ")",
        R_CURL => 78..79, // "}",
...
fn keyword_start() {
    ...
    lexer_matches!(&source, [
        PACKAGE => 0..7, // "package",
        WS => 7..8, // " ",
        IDENTIFIER_TOKEN => 8..11, // "dev",
        DOT => 11..12, // ".",
        IDENTIFIER_TOKEN => 12..17, // "ikeze",
        DOT => 17..18, // ".",
        IDENTIFIER_TOKEN => 18..30, // "kotlinsyntax",
        NL => 30..31, // "\n",
        NL => 31..32, // "\n",
        IMPORT => 32..38, // "import",
        WS => 38..39, // " ",
        IDENTIFIER_TOKEN => 39..45, // "kotlin",
        DOT => 45..46, // ".",
        IDENTIFIER_TOKEN => 46..53, // "streams",
        DOT => 53..54, // ".",
        IDENTIFIER_TOKEN => 54..60, // "toList",
        NL => 60..61, // "\n",
        NL => 61..62, // "\n",
        FUN => 62..65, // "fun",
        WS => 65..66, // " ",
        IDENTIFIER_TOKEN => 66..72, // "String",
        DOT => 72..73, // ".",
        IDENTIFIER_TOKEN => 73..79, // "length",
        L_PAREN => 79..80, // "(",
        R_PAREN => 80..81, // ")",
        COLON => 81..82, // ":",
        WS => 82..83, // " ",
        IDENTIFIER_TOKEN => 83..86, // "Int",
        WS => 86..87, // " ",
        ASSIGNMENT_TOKEN => 87..88, // "=",
        WS => 88..89, // " ",
        THIS => 89..93, // "this",
        DOT => 93..94, // ".",
        IDENTIFIER_TOKEN => 94..99, // "chars",
        L_PAREN => 99..100, // "(",
        R_PAREN => 100..101, // ")",
        DOT => 101..102, // ".",
        IDENTIFIER_TOKEN => 102..108, // "toList",
        L_PAREN => 108..109, // "(",
        R_PAREN => 109..110, // ")",
        DOT => 110..111, // ".",
        IDENTIFIER_TOKEN => 111..115, // "size",
        NL => 115..116, // "\n",
        NL => 116..117, // "\n",
        FUN => 117..120, // "fun",
        WS => 120..121, // " ",
        IDENTIFIER_TOKEN => 121..125, // "main",
        L_PAREN => 125..126, // "(",
        R_PAREN => 126..127, // ")",
        WS => 127..128, // " ",
        L_CURL => 128..129, // "{",
        ...
        QUOTE_CLOSE => 147..148, // "\"",
        DOT => 148..149, // ".",
        IDENTIFIER_TOKEN => 149..155, // "length",
        L_PAREN => 155..156, // "(",
        R_PAREN => 156..157, // ")",
        NL => 157..158, // "\n",
        IDENTIFIER_TOKEN => 158..165, // "println",
        L_PAREN => 165..166, // "(",
        IDENTIFIER_TOKEN => 166..169, // "len",
        R_PAREN => 169..170, // ")",
        NL => 170..171, // "\n",
        R_CURL => 171..172, // "}",
        EOF => 172..172
