...
use crate::{
    grammar2::{
        class_members::PROPERTY_DECLARATION_START, classes::starts_class_declaration,
        modifiers::modifiers,
    },
...
pub(crate) fn kotlin_file(parser: &mut Parser<'_>) {
    ...
    Some(m.complete(parser, KOTLIN_FILE));
}
...
pub(crate) fn declaration(
    ...
    } else if parser.at(T![fun]) && !parser.nth_at(1, T![interface]) {
