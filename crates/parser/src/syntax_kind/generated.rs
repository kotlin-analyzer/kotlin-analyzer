...
use crate::KtVersion;
#[doc = r" The kind of syntax node, e.g. `IDENT`, `FUN_KW`, or `CLASS_KW`."]
#[derive(Debug)]
#[repr(u16)]
pub enum SyntaxKind {
    #[doc(hidden)]
...
macro_rules ! T_ {
    ...
    [=] => { $ crate :: SyntaxKind :: EQ };
    [+=] => { $ crate :: SyntaxKind :: ADD_EQ };
    [*=] => { $ crate :: SyntaxKind :: MULT_EQ };
    [/=] => { $ crate :: SyntaxKind :: DIV_EQ };
    ...
    [quote] => { $ crate :: SyntaxKind :: QUOTE };
    [triple_quote] => { $ crate :: SyntaxKind :: TRIPLE_QUOTE };
