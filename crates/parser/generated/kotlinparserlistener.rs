 ...
 * @param ctx the parse tree
 */
fn enter_definitelyNonNullableType(&mut self, _ctx: &DefinitelyNonNullableTypeContext<'input>) { }
/**
 * Exit a parse tree produced by {@link KotlinParser#definitelyNonNullableType}.
 * @param ctx the parse tree
 */
fn exit_definitelyNonNullableType(&mut self, _ctx: &DefinitelyNonNullableTypeContext<'input>) { }
